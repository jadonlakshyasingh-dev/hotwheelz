...
function SignUpPage() {
  ...
  return (
    <AuthShell eyebrow="Join the garage">
      <h1 className="font-display text-2xl uppercase tracking-wider text-center mb-1">
        Sign up
      </h1>
      <p className="text-center text-xs text-muted-foreground mb-6">
        Build your collection. Free to start.
      </p>

      <GoogleButton loading={googleBusy} onClick={handleGoogle} label="Sign up with Google" />
      ...
      <p className="text-center text-xs text-muted-foreground mt-6">
        Already racing?{" "}
        <Link to="/signin" className="text-primary hover:underline uppercase tracking-wider">
          Sign in
        </Link>
      </p>
    </AuthShell>
