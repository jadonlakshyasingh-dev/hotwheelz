...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hotwheelz — premium die-cast cars, classic muscle, supercars, and rare limited-edition collectibles. Shop the drop with fast checkout and free shipping over $50." },
      { property: "og:site_name", content: "Hotwheelz" },
